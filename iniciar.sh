...
if [ -e "dadosBot.ini" ] ; then
	...
	echo "BUAA EL BOT YA ESTA CORRIENDO EN SEGUNDO PLANO MI KING CARDASHIAM EL MANDARIN SNIFF TE DA LA BIENVENIDA"
...
echo "LISTO PARA INICIAR BRO O BRA XD BUENO ESTE BOT YA ESTA EJECUTANDOSE EN SEGUNDO PLANO AHORA VE A TELEGRAM Y BUSCA  TU BOT E INICIALO / RECUERDA AGRADECER A @GATESCCN @LATAMSRC"
